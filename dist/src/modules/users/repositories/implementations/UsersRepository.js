...
var UsersRepository = /** @class */ (function () {
    ...
    UsersRepository.prototype.create = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, new User_1.User({
                            _id: (0, uuid_1.v4)(),
                            name: name,
                            email: email,
                            password: password,
    ...
    UsersRepository.prototype.cryptPassword = function (password) {
        var salt = bcrypt_1.default.genSaltSync(12);
        var passwordHash = bcrypt_1.default.hashSync(password, salt);
        return passwordHash;
    };
