...
var CategoriesRepository = /** @class */ (function () {
    ...
    CategoriesRepository.prototype.update = function (_a) {
        var id = _a.id, name = _a.name, description = _a.description;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, Category_1.Category.findByIdAndUpdate(id, {
                            name: name,
                            description: description,
                        })];
                    case 1: return [2 /*return*/, _b.sent()];
    ...
    CategoriesRepository.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Category_1.Category.findOneAndDelete({ _id: id })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    CategoriesRepository.prototype.searchCategories = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        filteredCategories = _a.sent();
                        return [2 /*return*/, filteredCategories];
                }
            });
        });
    };
    CategoriesRepository.prototype.findById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Category_1.Category.findById(id)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    CategoriesRepository.prototype.findByName = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Category_1.Category.findOne({ name: name })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
